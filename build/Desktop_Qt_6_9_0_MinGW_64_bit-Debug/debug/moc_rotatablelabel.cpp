...
#include "../../../src/ui/rotatablelabel.h"
...
namespace {
struct qt_meta_tag_ZN14RotatableLabelE_t {};
} // unnamed namespace

template <> constexpr inline auto RotatableLabel::qt_create_metaobjectdata<qt_meta_tag_ZN14RotatableLabelE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<RotatableLabel, qt_meta_tag_ZN14RotatableLabelE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject RotatableLabel::staticMetaObject = { {
    QMetaObject::SuperData::link<QLabel::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN14RotatableLabelE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN14RotatableLabelE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN14RotatableLabelE_t>.metaTypes,
    nullptr
} };
...
void *RotatableLabel::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN14RotatableLabelE_t>.strings))
